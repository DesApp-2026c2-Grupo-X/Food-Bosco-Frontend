...
const item = (id: string, ingredientId: string, quantity: number): RecipeItem => {
...
export const MOCK_RECIPES: Record<string, RecipeItem[]> = {
  '101': [
    item('1011', '1', 1),
    item('1012', '2', 1),
    item('1013', '3', 1),
...
export const getProductRecipe = (productId: string): RecipeItem[] => MOCK_RECIPES[productId] ?? []
