            ...
            <Card title="Rider asignado">
              <Muted fontSize="sm">
                {order.status === 'ON_THE_WAY'
                  ...
                  : 'El pedido volverá a estar disponible para que otro repartidor lo tome.'}
              </Muted>
              <SecondaryButton
                size="md"
                color="danger"
        ...
        <VStack align="stretch" gap="4">
          ...
          <Muted>
            {order?.status === 'ON_THE_WAY'
              ...
              : 'Se desasignará el rider del pedido y quedará disponible para que otro repartidor lo tome. El rider queda libre, sin sanción.'}
          </Muted>
          <HStack justify="end" gap="2">
